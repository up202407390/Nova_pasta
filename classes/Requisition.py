...
class Requisition(Gclass):
    ...
    att = ['_member_id', '_borrow_date', '_book_id', '_return_date']
    # Class header title
    header = 'Requisitions'
    # field description for use in, for example, input form
    des = ['Member id', 'Borrow date', 'Book id', 'Return date']
    
    
    def __init__(self, member_id, borrow_date, book_id, return_date):
        super().__init__()
